...
const getAllPets = async (req, res) => {
    try {
        ...
        (0, error_handler_1.handleHttp)(res, "ERROR_GET_ALL_PETS");
    }
};
...
const getPetId = async (req, res) => {
    ...
    try {
        ...
        (0, error_handler_1.handleHttp)(res, "ERROR_GET_PET");
    }
};
...
const createPet = async (req, res) => {
    ...
    try {
        ...
        if (error instanceof Error)
            (0, error_handler_1.handleHttp)(res, "ERROR_CREATE_PET");
    }
};
...
const updatePet = async (req, res) => {
    ...
    try {
        ...
        (0, error_handler_1.handleHttp)(res, "ERROR_UPDATE_PET");
    }
};
...
const deletePet = async (req, res) => {
    ...
    try {
        ...
        if (error instanceof Error) {
            (0, error_handler_1.handleHttp)(res, "ERROR_DELETE_PET");
        }
    }
};
