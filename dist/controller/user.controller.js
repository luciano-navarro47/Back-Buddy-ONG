...
const createUser = async (req, res) => {
    ...
    try {
        ...
        (0, error_handler_1.handleHttpError)(res, "ERROR_CREATE_USER");
    }
...
const getUserId = async (req, res) => {
    ...
    try {
        ...
        (0, error_handler_1.handleHttpError)(res, "ERROR_GET_USER");
    }
};
...
const updateUser = async (req, res) => {
    ...
    try {
        ...
        (0, error_handler_1.handleHttpError)(res, "ERROR_UPDATE_USERS");
    }
};
