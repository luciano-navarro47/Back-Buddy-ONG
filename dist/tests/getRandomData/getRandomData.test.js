...
const mockGetRandomData_1 = require("./mocks/mockGetRandomData");
test("getPetRandomData should return mocked pet data", async () => {
    const petData = await (0, mockGetRandomData_1.getPetRandomData)();
...
test("getUserRandomData should return mocked user data", async () => {
    const userData = await (0, mockGetRandomData_1.getUserRandomData)();
...
test("getProductRandomData should return mocked product data", async () => {
    const userData = await (0, mockGetRandomData_1.getProductRandomData)();
...
test("getVeterinaryRandomData should return mocked veterinary data", async () => {
    const veterinaryData = await (0, mockGetRandomData_1.getVeterinaryRandomData)();
    expect(veterinaryData).toHaveProperty("image", "https://fakeimage.com/image.jpg");
